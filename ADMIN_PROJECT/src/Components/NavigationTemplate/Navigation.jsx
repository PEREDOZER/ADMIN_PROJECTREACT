    ...
    return <div className={'navigation ${nav && "active"}'}>
        ...
        <header>
            <div className='profile'>
                <img src="https://avatars.mds.yandex.net/i?id=603737230a1785fabe35810faed2b3192736106c-8249766-images-thumbs&n=13" alt="user-img" className="profile-img" />
            </div>
            <span>creative ambition</span>
        </header>

        <Nav title="Dashboard" Icon={TbDashboard} />
        <Nav title="Analyticks" Icon={VscGraphLine} />
